	...
	<form id="frm" name="frm" enctype="multipart/form-data">
		<table class="board_view">
			...
			<tbody>
				...
				<tr>
					<th scope="row">제목</th>
					<td colspan="3"><input type="text" id="SUBJECT" name="SUBJECT" class="wdp_90" value="${map.SUBJECT }" /></td>
				</tr>
				<tr>
					<td colspan="4" class="view_text"><textarea rows="20" cols="100" title="내용" id="CONTENT" name="CONTENT">${map.CONTENT }</textarea></td>
				</tr>
				<tr>
